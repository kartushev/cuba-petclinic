...
export type DynamicAttributesConditionCreatorViewName = "_base" | "_local" | "_minimal";
export type DynamicAttributesConditionCreatorView<V extends DynamicAttributesConditionCreatorViewName> = never;
