...
export type GroupHierarchyView<V extends GroupHierarchyViewName> = V extends "_base" ? Pick<GroupHierarchy, "id" | "level"> : V extends "_local" ? Pick<GroupHierarchy, "id" | "level"> : never;
