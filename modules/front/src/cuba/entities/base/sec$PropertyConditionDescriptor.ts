...
export type PropertyConditionDescriptorViewName = "_base" | "_local" | "_minimal";
export type PropertyConditionDescriptorView<V extends PropertyConditionDescriptorViewName> = never;
